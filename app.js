$(function(){
  ...
  $.getJSON('https://api.yummly.com/v1/api/recipes?_app_id=5241297e&_app_key=a811f76dde33d08303b90321171edcc5&q='+recipeSearch+'&maxResult=10&start=10'+'&requirePictures=true', function(data){
    $.each(data.matches, function() {
      var thisId = this.id;
      console.log(this);
      var recipeName = this.recipeName;
      var recipeImage = this.smallImageUrls;
        $('.recipe-results').append("<div class='yummlyWrapper'><a href='http://www.yummly.com/recipe/"+thisId+"'><img style='width:150px;' src='"+recipeImage+"'><h2>"+recipeName+"</h2></a></div>")
      });
    });
  });
});
